...
{ 
    char name[80] ;     int at , bt , ct , tat , tbt , wt , priority ; 
}PROCESS ; 
 
PROCESS jobs[10] ; 
int time = 0 , processCount , totalTat=0 , totalWt = 0 ; float avgTat , avgWt ; 
...
{  
    ...
    printf("Process name\tArrival Time\tBurst Time\tCPU Time\tTurn Around time\tWait Time\n");    
    printf("----------------------\n");  
	    for(i=0 ; i<processCount ; i++)
